...
import math
import os
# 当运行yolov5的train.py出现ImportError: Bad git executable时，只需要在train.py中引入下面两句话即可：
#import os
...
def parse_opt(known=False):
   ...
   # parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/cellset.yaml', help='dataset.yaml path')
